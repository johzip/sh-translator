...
object Client extends App {
  ...
  //PlanningServices.planWithGivenDomainAndProblemNamePrintPlans("rover", "problem", 1)

  //PlanningServices.planWithGivenDomainAndProblemNamePrintPlans("forall", "problem", 1)
